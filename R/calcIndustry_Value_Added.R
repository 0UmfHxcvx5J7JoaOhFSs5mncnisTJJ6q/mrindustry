...
#' @importFrom dplyr case_when between bind_cols bind_rows distinct first last
#'   mutate n pull right_join select semi_join vars
...
#' @importFrom stats lm nls nls.control sd setNames SSlogis
